...
│   └── bin/
│       └── plugin-bg.wasm        # Compiled WASM component
└── frontend/                    # React + Vite frontend
    ...
    │   │       ├── plugin-bg.js  # Transpiled JS bindings
    │   │       ├── plugin-bg.d.ts
    │   │       └── interfaces/
    │   └── App.tsx              # React app (imports @wasm/plugin-bg.js)
...
**Import in React:**
```typescript
import { run as wasiCliRun } from '@wasm/plugin-bg.js'
...
The generated `plugin-bg.js` imports:
